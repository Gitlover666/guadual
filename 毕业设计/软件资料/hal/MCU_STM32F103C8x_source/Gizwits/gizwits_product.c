...
void userHandle(void)
{
 /*
    ...
    currentDataPoint.valueGQ = ;//Add Sensor Data Collection
    currentDataPoint.valueTemp_Q = ;//Add Sensor Data Collection
    currentDataPoint.valueSshidu_Q = ;//Add Sensor Data Collection
...
void userInit(void)
{
    ...
    /*
      ...
      currentDataPoint.valueGQ = ;
      currentDataPoint.valueTemp_Q = ;
      currentDataPoint.valueSshidu_Q = ;
    */
