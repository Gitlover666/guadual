...
* @{
*/
#define PRODUCT_KEY "124151e7128e4c3287597f4133ef4f4c"
/**@} */
/**@name Product Secret (产品密钥)
* @{
*/
#define PRODUCT_SECRET "eda9e33654994fa9bd4aeab442d7ba43"
/**@} */
...
* @{
*/
#define BEEP_ONOFF_BYTEOFFSET                    0
#define BEEP_ONOFF_BITOFFSET                     0
#define BEEP_ONOFF_LEN                           1

#define LED0_ONOFF_BYTEOFFSET                    0
#define LED0_ONOFF_BITOFFSET                     1
#define LED0_ONOFF_LEN                           1

#define LED1_ONOFF_BYTEOFFSET                    0
#define LED1_ONOFF_BITOFFSET                     2
#define LED1_ONOFF_LEN                           1
...
/** 用户区设备状态结构体*/
typedef_t struct {
  bool valueBeep_OnOff;
  bool valueLED0_OnOff;
  bool valueLED1_OnOff;
} dataPoint_t;

/** 对应协议“4.10 WiFi模组控制设备”中的标志位"attr_flags" */ 
typedef_t struct {
  uint8_t flagBeep_OnOff:1;
  uint8_t flagLED0_OnOff:1;
  uint8_t flagLED1_OnOff:1;
} attrFlags_t;
