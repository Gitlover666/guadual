...
* @{
*/
#define PRODUCT_KEY "50dfd048833c4283ba509979fa559a27"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "7b45a7c0de2940598f8e74c2903e9f49"
               
/**@name Device status data reporting interval
* @{
*/
#define REPORT_TIME_MAX 1000 //1S，这里是时间调整数值
/**@} */    
...
#define BEEP_BITOFFSET                     1
#define BEEP_LEN                           1
#define LED1_BYTEOFFSET                    0
#define LED1_BITOFFSET                     2
#define LED1_LEN                           1
#define Temp_Q_BYTEOFFSET                    5
#define Temp_Q_BITOFFSET                     0
#define Temp_Q_LEN                           1
#define Sshidu_Q_BYTEOFFSET                    5
#define Sshidu_Q_BITOFFSET                     1
#define Sshidu_Q_LEN                           1
#define Temp_AlarmScope_RATIO                         1
#define Temp_AlarmScope_ADDITION                      0
#define Temp_AlarmScope_MIN                           0
#define Temp_AlarmScope_MAX                           50
#define Shidu_AlarmScope_RATIO                         1
#define Shidu_AlarmScope_ADDITION                      20
#define Shidu_AlarmScope_MIN                           0
#define Shidu_AlarmScope_MAX                           95
#define GQ_AlarmScope_RATIO                         1
#define GQ_AlarmScope_ADDITION                      0
#define GQ_AlarmScope_MIN                           0
#define GQ_AlarmScope_MAX                           65535
#define Temp_RATIO                         1
#define Temp_ADDITION                      0//不是初始值，但是影响初始值，若为-10则显示加10，若为10则显示减10
#define Temp_MIN                           0
#define Temp_MAX                           55
...
typedef enum
{
  ...
  EVENT_BEEP,
	EVENT_LED1,
	EVENT_Temp_AlarmScope,
  EVENT_Shidu_AlarmScope,
  EVENT_GQ_AlarmScope,
...
typedef struct {
  ...
  bool valueBEEP;
	bool valueLED1;
	uint32_t valueTemp_AlarmScope;
  uint32_t valueShidu_AlarmScope;
  uint32_t valueGQ_AlarmScope;
  uint32_t valueTemp;
  uint32_t valueShidu;
  uint32_t valueGQ;
  bool valueTemp_Q;
...
typedef struct {
  ...
  uint8_t flagBEEP:1;
	uint8_t flagLED1:1;
	uint8_t flagTemp_AlarmScope:1;
  uint8_t flagShidu_AlarmScope:1;
  uint8_t flagGQ_AlarmScope:1;
} attrFlags_t;
...
typedef struct {
  uint8_t wBitBuf[COUNT_W_BIT];
	uint8_t valueTemp_AlarmScope;
  uint8_t valueShidu_AlarmScope;
  uint16_t valueGQ_AlarmScope;
} attrVals_t;
